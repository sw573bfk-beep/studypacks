window.PACKS = [
 {
  ...
  "blurb": "Official-style Year 8 Term 3 exam revision. Every checklist skill + all 60 revision questions with answers.",
  "topics": [
   "Perimeter & area",
   "Circles",
   "Volume & capacity",
  ...
  "theme": "blue",
  "focus": "practice",
  "studyTip": "Attempt the 60 revision questions like an exam first. Mark them, then only re-read notes for the topics you missed.",
  "emoji": "⭐",
  "examInfo": "Year 8 Maths · Term 3 Exam · 27 August 2026 · Measurement, Algebra & Linear Graphs",
  "homeTitle": "Your Term 3 exam pack — built from the real revision sheet",
  "homeIntro": "Notes for every skill on the checklist, then the full set of Class Education revision questions with worked answers so you can mark yourself properly.",
  "unitInfo": {
   "Measurement": {
    "blurb": "Perimeter, area, circles, volume, prisms and cylinders."
   },
   "Algebra": {
    "blurb": "Index laws, power of a power and zero index."
   },
   "Graphs": {
    "blurb": "Coordinates, tables, rules and straight-line graphs."
   }
  },
  "overview": [
   {
    "heading": "Measurement",
    "points": [
     "Perimeter = total outside edge. Convert units before calculating.",
     "Triangle A = ½bh. Trapezium A = ½(a+b)h. Keep units the same.",
     "Circle: C = 2πr = πd, A = πr². Annulus = πR² − πr².",
     "Prism V = base area × length. Cylinder V = πr²h.",
     "1 cm³ = 1 mL · 1000 cm³ = 1 L · 1 m³ = 1 kL."
    ]
   },
   {
    "heading": "Algebra",
    "points": [
     "Multiply same base → add indices. Divide → subtract indices.",
     "Power of a power → multiply indices. (ab)ⁿ = aⁿbⁿ.",
     "a⁰ = 1 (a ≠ 0). Odd powers keep a negative sign outside."
    ]
   },
   {
    "heading": "Graphs",
    "points": [
     "QI (+,+) QII (−,+) QIII (−,−) QIV (+,−).",
     "y = mx + c. Horizontal y = k. Vertical x = k.",
     "From a table: change in y per step of x is m; y at x = 0 is c."
    ]
   }
  ],
  "notes": [
   {
    "heading": "Perimeter, area and units",
    "unit": "Measurement",
    "body": "**Area conversions:** 1 m² = 10 000 cm².\n\n**Perimeter** = sum of outside edges only.\n\n**Formulas**\n- Rectangle: lw\n- Triangle: ½bh\n- Trapezium: ½(a + b)h\n\nMatch units before you multiply.",
    "image": null
   },
   {
    "heading": "Circles",
    "unit": "Measurement",
    "body": "**Radius** — centre to edge. **Diameter** — through centre (d = 2r). **Chord** — joins two points on the circle.\n\nC = 2πr = πd\nA = πr²\nAnnulus = πR² − πr²\n\nHalve the diameter before using the area formula.",
    "image": null
   },
   {
    "heading": "Volume and capacity",
    "unit": "Measurement",
    "body": "Prism: V = base area × length\nRectangular prism: lwh\nCylinder: πr²h\nHalf-cylinder: ½πr²h\n\n1 cm³ = 1 mL · 1000 cm³ = 1 L · 1 m³ = 1 kL",
    "image": null
   },
   {
    "heading": "Index laws",
    "unit": "Algebra",
    "body": "aᵐ × aⁿ = aᵐ⁺ⁿ\naᵐ ÷ aⁿ = aᵐ⁻ⁿ\n(aᵐ)ⁿ = aᵐⁿ\n(ab)ⁿ = aⁿbⁿ\n\n**Zero index:** a⁰ = 1 (a ≠ 0)\n\n**Negatives:** (−p²)³ = −p⁶ (odd outside power).",
    "image": null
   },
   {
    "heading": "Number plane and linear rules",
    "unit": "Graphs",
    "body": "Coordinates (x, y): across first.\n\n**Rule from table:** m = how y changes when x goes up 1; c = y when x = 0.\n\nHorizontal: y = k\nVertical: x = k",
    "image": null
   }
  ],
  "terms": [
   {
    "term": "Perimeter",
    "unit": "Measurement",
    "definition": "Total length around the outside of a shape."
   },
   {
    "term": "Chord",
    "unit": "Measurement",
    "definition": "Line joining two points on a circle. A diameter is a chord through the centre."
   },
   {
    "term": "Annulus",
    "unit": "Measurement",
   ...
   },
   {
    "term": "Prism",
    "unit": "Measurement",
    "definition": "3D shape with constant cross-section. V = base area × length."
   },
   {
    "term": "Zero index",
    "unit": "Algebra",
   ...
   },
   {
    "term": "y-intercept",
    "unit": "Graphs",
    "definition": "Where the line crosses the y-axis (value of c)."
   },
   {
    "term": "Origin",
    "unit": "Graphs",
  ...
  "cards": [
   ...
   {
    "front": "Horizontal line through 3?",
    "back": "y = 3"
   },
   {
    "front": "Vertical line through 3?",
    "back": "x = 3"
   },
   {
    "front": "(−2, 4) quadrant?",
  ...
  "quick": [
   ...
   {
    "q": "y = 0,2,4,6,8,10 for x = 0..5. Rule?",
    "options": [
     "y = x",
     "y = 2x",
     "y = 2x+1",
  ...
  "practice": [
   {
    "topic": "Q1 Perimeter",
    "q": "Find the outside perimeter of the composite shape (outer edges include 6 m, 3 m, 4 m, 4 m, 8 m).",
    "answer": "25 m",
    "accept": [
     "25",
     "25m",
    ...
    "why": "Add all outside sides: 6+3+4+4+8 = 25 m."
   },
   {
    "topic": "Q2 Units",
    "q": "11 m² = ______ cm²",
    ...
    "why": "1 m² = 10 000 cm² → 11 × 10 000 = 110 000."
   },
   {
    "topic": "Q3 Area",
   ...
   },
   {
    ...
    "why": "20 cm = 0.2 m. 8 × 0.2 = 1.6."
   },
   {
    "topic": "Q5 Area",
    "q": "Trapezium parallel sides 8 cm and 15 cm, height 3.2 cm. Area?",
    "answer": "36.8 cm²",
    "accept": [
     "36.8",
     "36.8cm²"
   ...
   {
    "topic": "Q6 Circles",
    "q": "Name a chord which is not a diameter (circle with centre Q).",
    "answer": "PT",
    "accept": [
     "PT",
     "TP",
    ...
    "why": "PT does not pass through the centre."
   },
   {
    "topic": "Q7 Circles",
    "q": "Which line is not a radius? (centre Q)",
    "answer": "PT",
    "accept": [
     "PT",
     "TP",
    ...
    "why": "PQ, QR, QS are radii. PT is not."
   },
   {
    "topic": "Q8 Circles",
    "q": "Circumference of circle radius 8 m, in terms of π.",
    "answer": "16π m",
    "accept": [
     "16π",
     "16π m",
   ...
   {
    "topic": "Q9 Circles",
    "q": "Shaded area (nearest whole number) using ½π(40² − 20²).",
    "answer": "1885 cm²",
    "accept": [
     "1885",
     "1885cm²"
   ...
   {
    "topic": "Q10 Circles",
    "q": "Circle diameter 36.5 cm. Area to 2 d.p.",
    "answer": "1046.35 cm²",
    "accept": [
     "1046.35",
     "1046.35cm²"
    ],
    "why": "r = 18.25; πr² ≈ 1046.35."
   },
   {
    "topic": "Q11 Circles",
   ...
   {
    "topic": "Q12 Volume",
    "q": "Box 80 cm × 35 cm filled to 48 cm depth. Capacity in litres.",
    "answer": "134.4 L",
    "accept": [
     "134.4",
     "134.4L",
    ...
    "why": "80×35×48 = 134400 cm³ = 134.4 L."
   },
   {
    "topic": "Q13 Volume",
    "q": "Hexagonal prism, face area 12.36 cm², length 3.432 cm. Volume (1 d.p.).",
    "answer": "42.4 cm³",
    "accept": [
     "42.4",
     "42.4cm³"
    ],
    "why": "12.36 × 3.432 ≈ 42.4."
   },
   {
    "topic": "Q14 Volume",
    "q": "Triangular prism, cross-section area 84 m², length 25 m. Volume?",
    "answer": "2100 m³",
    "accept": [
     "2100",
     "2100m³"
   ...
   {
    "topic": "Q17 Volume",
    "q": "Half-cylinder trough r = 3 m, length 5 m. Approx kL to fill (1 m³ = 1 kL).",
    "answer": "18 kL",
    "accept": [
     "18",
     "18kL",
   ...
   {
    "topic": "Q27 Index",
    "q": "Simplify (−p²)³ × (−p³)⁵. A p²¹  B −p¹³  C p¹³  D −p²¹",
    "answer": "A  p²¹",
    "accept": [
     "A",
     "p^21",
   ...
   {
    "topic": "Q28 Index",
    "q": "Simplify (−7m⁴)⁵ in index notation.",
    "answer": "−7⁵m²⁰",
    "accept": [
     "-7^5m^20",
     "-7^5 m^20",
    ...
    "why": "Odd power keeps minus; 4×5=20."
   },
   {
    "topic": "Q29 Index",
    "q": "Simplify (y²)³",
   ...
   {
    "topic": "Q40 Plane",
    "q": "Coordinates of A and B from the number plane.",
    "answer": "A(1, 2); B(−3, 5)",
    "accept": [
     "A(1,2) B(-3,5)",
     "A (1, 2), B (-3, 5)"
    ],
    "why": "Read from the grid."
   },
   {
    "topic": "Q41 Plane",
    "q": "Coordinates of C and D from the number plane.",
    "answer": "C(−2, −4); D(2, −5)",
    "accept": [
     "C(-2,-4) D(2,-5)",
     "C (−2, −4), D (2, −5)"
   ...
   {
    "topic": "Q42 Rules",
    "q": "Table x=0..5, y=0,2,4,6,8,10. Formula?",
    "answer": "y = 2x",
    "accept": [
     "y=2x",
     "y = 2x"
   ...
   {
    "topic": "Q43 Rules",
    "q": "Table x=0..5, y=10,8,6,4,2,0. Rule? A y=2x+10 B y=−2x+12 C y=−2x+10 D y=2x+8",
    "answer": "C  y = −2x + 10",
    "accept": [
     "C",
     "y=-2x+10",
    ...
    "why": "Falls by 2; intercept 10."
   },
   {
    "topic": "Q44 Rules",
    "q": "Pattern 1,4,7,10,13… (a) 7th term (b) Tₙ (c) 21st term",
    "answer": "a) 19  b) Tₙ = 3n − 2  c) 61",
    "accept": [
     "19; 3n-2; 61",
     "19, 3n-2, 61"
    ],
   ...
   },
   {
    ...
    "why": "z is always 3 more than p."
   },
   {
    "topic": "Q46 Rules",
    "q": "x: −1,0,1,2  y: 8,10,12,14. Complete y = 10 + ?x",
    "answer": "y = 10 + 2x",
    "accept": [
     "2",
     "y=10+2x",
   ...
   {
    "topic": "Q47 Rules",
    "q": "x:0..5 y:1,2,a,4,5,b. Find a, b and formula.",
    "answer": "a=3, b=6, y=x+1",
    "accept": [
     "a=3 b=6 y=x+1",
     "3, 6, y=x+1"
    ],
   ...
   {
    "topic": "Q48 Patterns",
    "q": "Triangles: 1,3,6,… (a) A for figure 4 (b) B for figure 5 (c) correct graph A or B",
    "answer": "a) 10  b) 15  c) A",
    "accept": [
     "10, 15, A",
     "A=10 B=15 graph A"
    ],
    "why": "Triangular numbers; graph A matches."
   },
   {
    "topic": "Q49 Graphs",
    "q": "Table x:−1,0,1 y:−1,0,1. Equation of the line?",
    "answer": "y = x",
    "accept": [
     "y=x",
     "y = x"
    ],
    "why": "Passes through origin with gradient 1."
   },
   {
    "topic": "Q50 Graphs",
    "q": "Line through (0,1),(1,2),(2,3). Equation and y when x=11.",
    "answer": "y = x + 1; y = 12",
    "accept": [
     "y=x+1, 12",
     "y = x + 1, 12"
   ...
   {
    "topic": "Q51 Graphs",
    "q": "Line through (0,2),(1,1),(2,0). Equation and y when x=−4.",
    "answer": "y = −x + 2; y = 6",
    "accept": [
     "y=-x+2, 6",
     "y = -x + 2, 6"
   ...
   {
    "topic": "Q52 Graphs",
    "q": "Line through (0,1),(1,2),(2,3),(3,4). Equation and y when x=5.",
    "answer": "y = x + 1; y = 6",
    "accept": [
     "y=x+1, 6",
     "y = x + 1, 6"
   ...
   {
    "topic": "Q55 Plane",
    "q": "(a) Coordinates of A (b) Coordinates of D (c) Point with (−3,−3)",
    "answer": "a) (4, 2)  b) (3, −3)  c) E",
    "accept": [
     "(4,2); (3,-3); E",
     "A(4,2) D(3,-3) E"
    ],
    "why": "From the labelled grid."
   },
   {
    "topic": "Q56 Tables",
    "q": "Which table follows y = 3x − 2 for x = −2, 0, 2?",
    "answer": "C (−8, −2, 4)",
    "accept": [
     "C",
     "y=-8,-2,4"
    ],
    "why": "Substitute to check."
   },
   {
    "topic": "Q57 Patterns",
    "q": "Squares: 5,9,13,… Find A (fig4), B (fig5), C (fig6).",
    "answer": "A=17, B=21, C=25",
    "accept": [
     "17, 21, 25",
     "A=17 B=21 C=25"
    ],
   ...
   {
    "topic": "Q58 Graphs",
    "q": "Horizontal line on the graph. Equation and y when x = −1.",
    "answer": "y = 3; y = 3",
    "accept": [
     "y=3, 3",
     "y = 3"
    ],
    "why": "Horizontal through 3."
   },
   {
    "topic": "Q59 Graphs",
    "q": "Vertical line on the graph. Equation and x when y = 4.",
    "answer": "x = 3; x = 3",
    "accept": [
     "x=3, 3",
     "x = 3"
    ],
    "why": "Vertical through 3."
   },
   {
    "topic": "Q60 Graphs",
    "q": "Line through origin gradient 1. Equation and y when x = 13.",
    "answer": "y = x; y = 13",
    "accept": [
     "y=x, 13",
     "y = x, 13"
  ...
  "quiz": [
   {
    "q": "Show how to convert the 80×35×48 cm box into litres.",
    "a": "Volume = 80×35×48 = 134400 cm³. Divide by 1000 → 134.4 L.",
    "hint": "1 L = 1000 cm³."
   },
   {
    "q": "Fully simplify (25x³⁶y⁴)/(5x⁶y¹⁶).",
    "a": "5x³⁰/y¹²",
    "hint": "Subtract indices for each base."
   },
   {
    "q": "For 1,4,7,10,13… give Tₙ and the 21st term.",
    "a": "Tₙ = 3n−2; T₂₁ = 61.",
    "hint": "Common difference 3."
   },
   {
    "q": "Line through (0,1) and (1,2). Equation and y at x = 11.",
    "a": "y = x+1; y = 12.",
    "hint": "Read m and c."
   },
   {
    "q": "Why is a vertical line’s gradient undefined?",
    "a": "Run = 0, and you cannot divide by zero.",
    "hint": "rise ÷ run."
   }
  ],
  "exam": {
