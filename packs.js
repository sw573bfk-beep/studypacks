window.PACKS = [
 {
  ...
  "theme": "blue",
  "focus": "practice",
  "studyTip": "Maths is practice. Pick one topic label in Practice, do those questions, check the why, then move to the next type. Use notes only when stuck.",
  "emoji": "⭐",
  ...
  "homeIntro": "Organised the way you revise: short how-to notes, then practice grouped by skill (perimeter, circles, volume, index laws, graphs…). Finish with the full revision-sheet style questions.",
  "unitInfo": {
   "Measurement": {
  ...
  "notes": [
   ...
   },
   {
    ...
    "unit": "Graphs",
    "body": "**x-axis** horizontal · **y-axis** vertical · **origin** (0,0)\n\n**Coordinates (x, y)** — across first, then up/down\n\n**Quadrants**\n- I (+, +)\n- II (−, +)\n- III (−, −)\n- IV (+, −)\n\nPlot: from origin move x, then y.\nRead: write the pair in brackets.",
    "image": null
   },
   {
   ...
   },
   {
    ...
    "unit": "Graphs",
    "body": "**y-intercept** — crosses y-axis → **x = 0** → point (0, c)\n**x-intercept** — crosses x-axis → **y = 0** → solve for x → (a, 0)\n\n**Sketch from intercepts**\n1. Find both intercepts\n2. Plot them\n3. Rule a straight line\n4. Label intercepts and the equation\n\n**Example:** y = 2x − 6\ny-intercept (0, −6)\n0 = 2x − 6 → x = 3 → (3, 0)",
    "image": null
   },
   {
    "heading": "Gradient",
    "unit": "Graphs",
    "body": "**Gradient m = rise ÷ run**\n\n- **Positive** — up left to right\n- **Negative** — down left to right\n- **Zero** — horizontal (y = k)\n- **Undefined** — vertical (x = k), run = 0\n\nBetween (x₁,y₁) and (x₂,y₂):\nm = (y₂ − y₁) / (x₂ − x₁)\n\n**Example:** (1,2) to (4,8) → (8−2)/(4−1) = **2**",
    "image": null
   },
   {
    "heading": "Gradient-intercept form",
    "unit": "Graphs",
    "body": "**y = mx + c**\n- m = gradient\n- c = y-intercept\n\n**From a graph:** read c on the y-axis; count rise/run for m.\n\n**Special lines**\n- Horizontal: **y = k** (m = 0)\n- Vertical: **x = k** (undefined gradient — not y = mx + c)\n\n**Example:** gradient 2 through (0, −3) → **y = 2x − 3**",
    "image": null
   },
   {
  ...
  "practice": [
   {
    "topic": "1 Perimeter",
    "q": "An L-shape has outside edges 9 cm, 5 cm, 4 cm, 3 cm, 5 cm, 2 cm. Find the perimeter.",
    "answer": "28 cm",
    "why": "Add outside edges only: 9+5+4+3+5+2=28.",
    "accept": [
     "28",
     "28cm"
    ]
   ...
   {
    "topic": "1 Perimeter",
    "q": "A rectangle 11 m by 6 m has a 3 m by 2 m rectangle cut from one corner (cut removes two outer edges of 3 and 2 but adds the same inward). Find the outside perimeter of the remaining shape.",
    "answer": "34 m",
    "why": "Outer path length equals original perimeter 2(11+6)=34 — internal cut does not change outer perimeter for a corner bite of this type.",
    "accept": [
     "34",
     "34m"
    ]
   ...
   {
    "topic": "1 Perimeter",
    "q": "Find the perimeter of a composite shape with outside sides 6 m, 3 m, 4 m, 4 m and 8 m.",
    "answer": "25 m",
    "why": "6+3+4+4+8=25.",
    "accept": [
     "25",
   ...
   {
    "topic": "1 Perimeter",
    "q": "A shape has sides 12 cm, 7 cm, 5 cm, 7 cm, 12 cm, 9 cm. Perimeter?",
    "answer": "52 cm",
    "why": "Sum all outside sides.",
    "accept": [
     "52",
     "52cm"
    ]
   ...
   {
    "topic": "3 Circumference",
    "q": "Radius 8 m. Circumference in terms of π.",
    "answer": "16π m",
    "why": "C=2πr=16π.",
    "accept": [
     "16π",
   ...
   {
    "topic": "3 Circumference",
    "q": "Diameter 9 cm. Circumference using π=3.14.",
    "answer": "28.26 cm",
    "why": "C=πd=3.14×9.",
    "accept": [
     "28.26",
   ...
   {
    "topic": "3 Circumference",
    "q": "Radius 5 cm. Semicircle perimeter using π=3.14 (curve + diameter).",
    "answer": "25.7 cm",
    "why": "πr+2r=15.7+10=25.7.",
    "accept": [
     "25.7",
     "25.7cm"
    ]
   ...
   {
    "topic": "3 Circumference",
    "q": "Radius 6 cm. Quadrant perimeter using π=3.14.",
    "answer": "21.42 cm",
    "why": "(πr)/2 + 2r = 9.42+12=21.42.",
    "accept": [
     "21.42",
     "21.42cm"
    ]
   ...
   {
    "topic": "4 Basic area",
    "q": "Triangle base 14 cm, height 6 cm. Area?",
    "answer": "42 cm²",
    "why": "½×14×6=42.",
    "accept": [
     "42",
   ...
   {
    "topic": "4 Basic area",
    "q": "Parallelogram base 11 m, perpendicular height 4 m. Area?",
    "answer": "44 m²",
    "why": "11×4=44.",
    "accept": [
     "44",
   ...
   {
    "topic": "4 Basic area",
    "q": "Rectangle 8 m by 20 cm. Area in m².",
    "answer": "1.6 m²",
    "why": "0.2×8=1.6.",
    "accept": [
     "1.6",
   ...
   {
    "topic": "4 Basic area",
    "q": "Triangle base 1.2 m, height 20 cm. Area in cm².",
    "answer": "1200 cm²",
    "why": "120×20÷2=1200.",
    "accept": [
     "1200",
   ...
   {
    "topic": "5 Special quads",
    "q": "Kite diagonals 16 cm and 9 cm. Area?",
    "answer": "72 cm²",
    "why": "½×16×9=72.",
    "accept": [
     "72",
   ...
   {
    "topic": "5 Special quads",
    "q": "Trapezium parallel sides 8 cm and 12 cm, height 5 cm. Area?",
    "answer": "50 cm²",
    "why": "½(8+12)×5=50.",
    "accept": [
     "50",
   ...
   {
    "topic": "5 Special quads",
    "q": "Rhombus diagonals 12 cm and 5 cm. Area?",
    "answer": "30 cm²",
    "why": "½×12×5=30.",
    "accept": [
     "30",
   ...
   {
    "topic": "5 Special quads",
    "q": "Trapezium parallel sides 9 cm and 15 cm, area 72 cm². Find height.",
    "answer": "6 cm",
    "why": "72=½(24)h → h=6.",
    "accept": [
     "6",
   ...
   {
    "topic": "6 Circle area",
    "q": "Annulus outer r=5 m, inner r=3 m. Area to 2 d.p.",
    "answer": "50.27 m²",
    "why": "π(25−9)=16π≈50.27.",
    "accept": [
     "50.27",
     "50.27m²"
    ]
   ...
   {
    "topic": "7 Volume",
    "q": "Box 80 cm × 35 cm × 48 cm. Capacity in litres.",
    "answer": "134.4 L",
    "why": "134400 cm³ ÷ 1000.",
    "accept": [
     "134.4",
   ...
   {
    "topic": "7 Volume",
    "q": "Rectangular prism 2 m × 4 m × 12 m. Volume?",
    "answer": "96 m³",
    "why": "2×4×12.",
    "accept": [
     "96",
   ...
   {
    "topic": "7 Volume",
    "q": "Triangular prism, base area 84 m², length 25 m. Volume?",
    "answer": "2100 m³",
    "why": "84×25.",
    "accept": [
     "2100",
   ...
   {
    "topic": "8 Cylinders",
    "q": "Cylinder r=3 m, h=7 m. Volume to 1 d.p.",
    "answer": "197.9 m³",
    "why": "π×9×7.",
    "accept": [
     "197.9",
   ...
   {
    "topic": "8 Cylinders",
    "q": "Cylinder diameter 18 cm, height 22 cm. Volume to 2 d.p.",
    "answer": "5598.32 cm³",
    "why": "r=9; π×81×22.",
    "accept": [
     "5598.32"
   ...
   {
    "topic": "8 Cylinders",
    "q": "Cylinder r=4 cm, h=12 cm. Volume nearest whole number.",
    "answer": "603 cm³",
    "why": "π×16×12≈603.",
    "accept": [
     "603"
   ...
   {
    "topic": "8 Cylinders",
    "q": "Half-cylinder trough r=3 m, length 5 m. Approx kL (1 m³=1 kL).",
    "answer": "18 kL",
    "why": "½π×9×5≈17.7≈18.",
    "accept": [
     "18",
   ...
   },
   {
    ...
    "q": "Simplify 4p²q³ × 2pq²",
    "answer": "8p³q⁵",
    "why": "Add indices; multiply coefficients.",
    "accept": [
     "8p^3q^5",
     "8p3q5"
    ]
   ...
   {
    "topic": "12 Power of a power",
    "q": "Simplify (−7m⁴)⁵ in index form",
    "answer": "−7⁵m²⁰",
    "why": "Odd power keeps minus.",
    "accept": [
     "-7^5m^20",
     "−7^5m^20"
    ]
   ...
   {
    "topic": "14 Number plane",
    "q": "Which quadrant is (2, 4) in?",
    "answer": "I",
    "why": "Both positive.",
    "accept": [
     "I",
   ...
   {
    "topic": "15 Finding rules",
    "q": "Table x=0..5, y=0,2,4,6,8,10. Rule?",
    "answer": "y = 2x",
    "why": "m=2, c=0.",
    "accept": [
     "y=2x",
   ...
   {
    "topic": "15 Finding rules",
    "q": "Table x=0..5, y=10,8,6,4,2,0. Rule?",
    "answer": "y = −2x + 10",
    "why": "Falls by 2; c=10.",
    "accept": [
     "y=-2x+10",
   ...
   {
    "topic": "15 Finding rules",
    "q": "Pattern 1,4,7,10,13… Formula for nth term Tₙ?",
    "answer": "Tₙ = 3n − 2",
    "why": "Difference 3; check n=1.",
    "accept": [
     "3n-2",
     "T=3n-2",
     "Tn=3n-2"
   ...
   {
    "topic": "15 Finding rules",
    "q": "Table x=−1,0,1,2 and y=8,10,12,14. Rule?",
    "answer": "y = 10 + 2x",
    "why": "m=2; at x=0, y=10.",
    "accept": [
     "y=10+2x",
   ...
   {
    "topic": "15 Finding rules",
    "q": "Table x=0..5, y=1,2,3,4,5,6. Rule?",
    "answer": "y = x + 1",
    "why": "m=1, c=1.",
    "accept": [
     "y=x+1",
   ...
   {
    "topic": "16 Intercepts",
    "q": "y-intercept of y = 3x + 7 as a coordinate.",
    "answer": "(0, 7)",
    "why": "x=0 → y=7.",
    "accept": [
     "(0,7)",
   ...
   {
    "topic": "16 Intercepts",
    "q": "x-intercept of y = 2x − 8 as a coordinate.",
    "answer": "(4, 0)",
    "why": "0=2x−8 → x=4.",
    "accept": [
     "(4,0)",
   ...
   {
    "topic": "17 Gradient",
    "q": "Gradient between (1, 5) and (3, 11).",
    "answer": "3",
    "why": "(11−5)/(3−1)=3.",
    "accept": [
     "3",
   ...
   {
    "topic": "17 Gradient",
    "q": "Gradient between (0, 5) and (2, 1).",
    "answer": "−2",
    "why": "(1−5)/(2−0)=−2.",
    "accept": [
     "-2",
   ...
   {
    "topic": "17 Gradient",
    "q": "Gradient of the horizontal line y = 7.",
    "answer": "0",
    "why": "Rise is 0.",
    "accept": [
     "0",
   ...
   {
    "topic": "17 Gradient",
    "q": "Gradient of the vertical line x = 3.",
    "answer": "Undefined",
    "why": "Run is 0.",
    "accept": [
     "undefined",
   ...
   {
    "topic": "18 y = mx + c",
    "q": "In y = 4x − 1, what is the gradient?",
    "answer": "4",
   ...
   {
    "topic": "18 y = mx + c",
    "q": "Equation of horizontal line through 3.",
    "answer": "y = 3",
    "why": "y always 3.",
    "accept": [
     "y=3",
   ...
   {
    "topic": "18 y = mx + c",
    "q": "Equation of vertical line through 3.",
    "answer": "x = 3",
    "why": "x always 3.",
    "accept": [
     "x=3",
   ...
   {
    "topic": "18 y = mx + c",
    "q": "Gradient 2, passes through (0, −3). Rule?",
    "answer": "y = 2x − 3",
    "why": "m=2, c=−3.",
    "accept": [
     "y=2x-3",
   ...
   {
    "topic": "18 y = mx + c",
    "q": "Line through (0,1) and (1,2). Equation?",
    "answer": "y = x + 1",
    "why": "m=1, c=1.",
    "accept": [
     "y=x+1",
   ...
   {
    "topic": "19 Applications",
    "q": "Bike hire $8 plus $6/hour. Rule for cost C after t hours.",
    "answer": "C = 6t + 8",
    "why": "Rate 6, start 8.",
    "accept": [
     "C=6t+8",
   ...
   {
    "topic": "19 Applications",
    "q": "Michael has $250 and saves $40/week. Amount A after w weeks?",
    "answer": "A = 40w + 250",
    "why": "Start 250, rate 40.",
    "accept": [
     "A=40w+250",
     "A = 40w + 250"
    ]
   ...
   {
    "topic": "19 Applications",
    "q": "Tank 2000 L leaks 60 L per day. Volume V after d days?",
    "answer": "V = 2000 − 60d",
    "why": "Starts full, loses 60/day.",
    "accept": [
     "V=2000-60d",
     "V = 2000 - 60d"
    ]
   ...
   {
    "topic": "19 Applications",
    "q": "Using C = 5t + 12, cost after 3 hours?",
    "answer": "27",
    "why": "15+12=27.",
    "accept": [
     "27",
   ...
   {
    "topic": "20 Exam mix",
    "q": "Using y = 3x − 4, find y when x = −1.",
    "answer": "−7",
    "why": "3(−1)−4=−7.",
    "accept": [
     "-7",
   ...
   {
    "topic": "20 Exam mix",
    "q": "Using y = 4x − 3, find y when x = −3.",
    "answer": "−15",
    "why": "4(−3)−3=−15.",
    "accept": [
     "-15",
   ...
   {
    "topic": "20 Exam mix",
    "q": "Pattern of squares 5,9,13,… What is the 6th term?",
    "answer": "25",
    "why": "+4 each time: 5,9,13,17,21,25.",
    "accept": [
     "25"
    ]
   },
 ...
 },
 {
  ...
  "theme": "green",
  "focus": "practice",
  "studyTip": "Read one short notes section, then do the Practice questions for that topic straight away. Checking the ‘why’ after each answer is what moves a C toward a B.",
  "emoji": "📗",
  "examInfo": "Year 7 Maths · Term 3 · Understanding & Fluency + Problem Solving exams",
  "homeTitle": "Term 3 maths, explained simply",
  "homeIntro": "Built for clear steps, not long textbook pages. Learn the method, try a few questions, then check the why. Cover fractions through to transformations.",
  "unitInfo": {
   "Fractions & Decimals": {
  ...
  "overview": [
   {
    ...
    "points": [
     ...
     "Divide fractions: KEEP the first, CHANGE ÷ to ×, FLIP the second.",
     "Fraction → decimal: divide top by bottom.",
     "Decimal → percentage: × 100 and add %.",
     "Percentage → decimal: ÷ 100.",
     "Percentage of an amount: turn % into a decimal, then multiply."
    ]
   },
   {
    "heading": "Decimals & ratios",
    "points": [
     "Line up the decimal points when adding or subtracting.",
     "When multiplying decimals, multiply as normal, then count decimal places.",
     "A ratio compares parts, like 2:3.",
     "Simplify a ratio by dividing both sides by the same number (HCF)."
    ]
   },
   {
    "heading": "Angles & transformations",
    "points": [
     "Angles in a triangle always add to 180°.",
     "Angles in a quadrilateral always add to 360°.",
     "Transformations: Slide (translate), Flip (reflect), Turn (rotate). Remember SFT."
    ]
   }
  ],
  "notes": [
   {
    ...
    "unit": "Fractions & Decimals",
    "body": "**Method**\n1. Multiply the numerators (tops)\n2. Multiply the denominators (bottoms)\n3. Simplify if you can\n\n**Example:** ⅔ × ¾\n= (2×3)/(3×4) = 6/12 = **½**\n\n**Mixed numbers:** turn into improper fractions first.\n1½ × ⅔ = 3/2 × 2/3 = 6/6 = **1**\n\n**Tip:** You can cancel (cross-simplify) before multiplying to keep numbers small.",
    "image": null
   },
   {
    "heading": "Dividing fractions — Keep, Change, Flip",
    "unit": "Fractions & Decimals",
    "body": "**KEEP · CHANGE · FLIP**\n1. **KEEP** the first fraction\n2. **CHANGE** the ÷ sign to ×\n3. **FLIP** the second fraction (swap top and bottom)\n4. Multiply as usual\n\n**Example:** ⅔ ÷ ¼\n= ⅔ × 4/1 = 8/3 = **2⅔**\n\n**Example:** ¾ ÷ ½\n= ¾ × 2/1 = 6/4 = **1½**\n\n**Why it works:** dividing by a fraction is the same as multiplying by its reciprocal.",
    "image": null
   },
   {
    "heading": "Fractions, decimals and percentages",
    "unit": "Fractions & Decimals",
    "body": "**Fraction → decimal**\nDivide top by bottom. ¾ = 3÷4 = **0.75**\n\n**Decimal → percentage**\n× 100. 0.75 × 100 = **75%**\n\n**Percentage → decimal**\n÷ 100. 40% = **0.4**\n\n**Percentage → fraction**\nPut over 100 and simplify. 40% = 40/100 = **⅖**\n\n**Handy ones to know cold**\n½ = 0.5 = 50%\n¼ = 0.25 = 25%\n¾ = 0.75 = 75%\n⅕ = 0.2 = 20%\n1/10 = 0.1 = 10%",
    "image": null
   },
   {
    "heading": "Working with decimals",
    "unit": "Fractions & Decimals",
    "body": "**Add / subtract**\nLine up the decimal points. Fill empty places with 0 if it helps.\n3.4 + 1.25 = **4.65**\n\n**Multiply**\n1. Multiply as if there were no decimal points\n2. Count total decimal places in the question\n3. Put that many places in the answer\n\n**Example:** 1.2 × 0.3\n12 × 3 = 36, two decimal places → **0.36**\n\n**Divide**\nMove the point in the divisor to make it a whole number, and move the dividend’s point the same number of places.",
    "image": null
   },
   {
    "heading": "Percentages of quantities",
    "unit": "Percentages & Ratios",
    "body": "**Method**\n1. Turn the percentage into a decimal (÷ 100)\n2. Multiply by the amount\n\n**Example:** 20% of 60\n0.2 × 60 = **12**\n\n**Example:** 15% of 80\n0.15 × 80 = **12**\n\n**Quick tricks**\n- 10% = divide by 10\n- 50% = half\n- 25% = quarter\n- 5% = half of 10%\n\n**Example:** 15% of 40 = 10% (4) + 5% (2) = **6**",
    "image": null
   },
   {
    "heading": "Ratios",
    "unit": "Percentages & Ratios",
    "body": "A **ratio** compares amounts of the same kind, written a:b.\n\n**Simplify**\nDivide both sides by the highest common factor (HCF).\n\n**Example:** 8:12 ÷4 → **2:3**\n**Example:** 15:25 ÷5 → **3:5**\n\n**Sharing in a ratio**\n1. Add the parts\n2. Divide the total by that sum (one part)\n3. Multiply by each side of the ratio\n\n**Example:** Share $40 in the ratio 2:3\nParts = 5. One part = 8.\n2 parts = **$16**, 3 parts = **$24**.",
    "image": null
   },
   {
    "heading": "Angles in triangles and quadrilaterals",
    "unit": "Shapes",
    "body": "**Triangle:** angles add to **180°**\nIf two angles are 50° and 60°, the third is 180−50−60 = **70°**\n\n**Quadrilateral** (4 sides): angles add to **360°**\nIf three angles are 80°, 90° and 100°, the fourth is 360−270 = **90°**\n\n**Memory**\n- Triangle → 180\n- Quad → 360 (double a triangle)",
    "image": null
   },
   {
    "heading": "Transformations — SFT",
    "unit": "Shapes",
    "body": "**SFT = Slide, Flip, Turn**\n\n- **Slide (translate)** — move the shape without turning it. Every point moves the same distance and direction.\n- **Flip (reflect)** — mirror image over a line (like a flip in water).\n- **Turn (rotate)** — spin around a point by an angle (90°, 180°, 270°…).\n\n**What stays the same?**\nSize and shape stay the same for all three. Only position or facing changes.\n\n**Tip:** If it looks like a mirror → flip. If it moved but faces the same way → slide. If it spun → turn.",
    "image": null
   }
  ],
  "terms": [
