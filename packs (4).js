 ...
 },
{
 ...
 "blurb": "Year 8 Maths Term 3 exam revision: length, area, volume, algebra, index laws and linear graphs.",
 "topics": [
  "Length & perimeter",
  "Circumference",
  "Area of shapes",
 ...
 "theme": "blue",
 "focus": "practice",
 "studyTip": "Maths sticks by doing. Skim one notes section, then jump straight into Practice and Quick questions. Fix every wrong answer before moving on.",
 "emoji": "📐",
 "examInfo": "Year 8 Maths · Term 3 Exam · 27 August 2026 · Measurement, Algebra & Graphs",
 "homeTitle": "Everything on your Term 3 exam, in one place",
 "homeIntro": "Built from your exam outline: measurement and geometry, algebra and index laws, and the number plane with straight-line graphs. Short on time? Start with the Overview, then drill Practice.",
 "unitInfo": {
  "Measurement": {
   "blurb": "Length, perimeter, circumference, area and volume."
  },
  "Algebra": {
   "blurb": "Terms, expanding, factorising and index laws."
  },
  "Graphs": {
   "blurb": "Coordinates, tables, gradient and y = mx + c."
  }
 },
 "overview": [
  {
   "heading": "Measurement & Geometry",
   "points": [
    "Convert length: mm → cm ÷ 10, cm → m ÷ 100, m → km ÷ 1000 (reverse to go up).",
    "**Perimeter** = total distance around. Add every outside edge of a composite shape.",
    "Circle: **C = 2πr** or **C = πd**. Use π ≈ 3.14 unless told otherwise.",
    "Semicircle perimeter = **πr + 2r** (curved part + diameter). Quadrant = **(πr)/2 + 2r**.",
    "Area: square **s²**, rectangle **l × w**, triangle **½bh**, parallelogram **bh**.",
    "Kite/rhombus: **½ × d₁ × d₂**. Trapezium: **½(a + b)h**.",
    "Circle area: **A = πr²**. If given diameter, halve it first.",
    "Volume of prism/cylinder = **area of base × height**. Capacity is how much liquid it holds."
   ]
  },
  {
   "heading": "Algebra & Index Laws",
   "points": [
    "**Like terms** have the same letter parts (3x and 5x). Add/subtract coefficients only.",
    "Multiply: **2a × 3b = 6ab**. Divide: **6ab ÷ 2a = 3b**.",
    "Expand: **a(b + c) = ab + ac**. Factorise: take out the HCF.",
    "Index Law 1: **aᵐ × aⁿ = aᵐ⁺ⁿ**. Law 2: **aᵐ ÷ aⁿ = aᵐ⁻ⁿ**.",
    "Zero index: **a⁰ = 1** (a ≠ 0). Power of a power: **(aᵐ)ⁿ = aᵐⁿ**.",
    "**(ab)ⁿ = aⁿbⁿ**. **(a/b)ⁿ = aⁿ/bⁿ**."
   ]
  },
  {
   "heading": "Number Plane & Linear Graphs",
   "points": [
    "Coordinates **(x, y)** — across first, then up/down. Origin is **(0, 0)**.",
    "Four quadrants: I (+,+), II (−,+), III (−,−), IV (+,−).",
    "Table of values: substitute each x into the rule to get y.",
    "**y = mx + c** — m is gradient, c is y-intercept.",
    "x-intercept: set **y = 0**. y-intercept: set **x = 0** (gives c).",
    "Gradient = **rise ÷ run**. Positive = up, negative = down, 0 = horizontal, undefined = vertical."
   ]
  }
 ],
 "notes": [
  {
   "heading": "Length and perimeter",
   "unit": "Measurement",
   "body": "Length units (biggest to smallest): km, m, cm, mm.\n\n**Converting**\n- To a *smaller* unit → multiply (more of them fit)\n- To a *larger* unit → divide\n\nExamples: 3 m = 300 cm, 45 mm = 4.5 cm, 2.5 km = 2500 m.\n\n**Perimeter** is the total distance around a shape. For composite shapes, add every outer edge — don't count edges that are inside where shapes join.\n\n**Worked example 1:** A rectangle 8 cm by 5 cm.\nP = 2(8 + 5) = 26 cm.\n\n**Worked example 2:** An L-shape with outer edges 6, 4, 3, 2, 3, 2 cm.\nAdd them: 6 + 4 + 3 + 2 + 3 + 2 = 20 cm.",
   "image": null
  },
  {
   "heading": "Circumference of a circle",
   "unit": "Measurement",
   "body": "A **circle** has:\n- **Centre** — middle point\n- **Radius (r)** — centre to edge\n- **Diameter (d)** — all the way across through the centre\n\n**d = 2r** and **r = d ÷ 2**.\n\n**Circumference** is the perimeter of a circle.\n\n**C = 2πr** or **C = πd**\n\nUse **π ≈ 3.14** unless the question says otherwise.\n\n**When to use which**\n- Given radius → **C = 2πr**\n- Given diameter → **C = πd** (faster, no need to halve first)\n\n**Semicircle perimeter** = curved part + diameter = **πr + 2r** (or **½πd + d**).\n\n**Quadrant perimeter** = quarter curve + two radii = **(πr)/2 + 2r**.\n\n**Worked example:** r = 5 cm, π = 3.14\nC = 2 × 3.14 × 5 = 31.4 cm.\n\n**Worked example:** d = 10 cm\nC = 3.14 × 10 = 31.4 cm.",
   "image": null
  },
  {
   "heading": "Area of basic shapes",
   "unit": "Measurement",
   "body": "**Formula box**\n- Square: **A = s²**\n- Rectangle: **A = l × w**\n- Triangle: **A = ½ × b × h** (height must be perpendicular to the base)\n- Parallelogram: **A = b × h** (same — perpendicular height)\n\n**Area units:** mm², cm², m², km². Hectare: **1 ha = 10 000 m²**.\n\n**Converting area:** 1 m² = 10 000 cm². Scale factor is squared when you convert.\n\n**Composite area — addition:** split into rectangles/triangles, find each area, add.\n\n**Composite area — subtraction:** take a big shape and subtract a cut-out.\n\n**Worked example:** Triangle base 8 cm, height 5 cm.\nA = ½ × 8 × 5 = 20 cm².",
   "image": null
  },
  {
   "heading": "Special quadrilaterals",
   "unit": "Measurement",
   "body": "**Kite** — two pairs of adjacent equal sides. Diagonals cross at right angles; one is a line of symmetry.\n\n**Rhombus** — all four sides equal. Diagonals bisect each other at right angles.\n\n**Trapezium** (Australian spelling) — exactly one pair of parallel sides (the bases).\n\n**Area rules**\n- Kite or rhombus: **A = ½ × d₁ × d₂** (product of diagonals, halved)\n- Trapezium: **A = ½(a + b) × h** where a and b are the parallel sides, h is perpendicular height\n\n**Worked example:** Rhombus diagonals 10 cm and 8 cm.\nA = ½ × 10 × 8 = 40 cm².\n\n**Worked example:** Trapezium parallel sides 6 cm and 10 cm, height 4 cm.\nA = ½(6 + 10) × 4 = 32 cm².",
   "image": null
  },
  {
   "heading": "Area of a circle",
   "unit": "Measurement",
   "body": "**A = πr²**\n\nAlways use the **radius**. If you are given the diameter, **halve it first**.\n\n**Semicircle area** = **½πr²**\n**Quadrant area** = **¼πr²**\n\n**Worked example:** r = 4 cm, π = 3.14\nA = 3.14 × 16 = 50.24 cm².\n\n**Worked example:** d = 10 cm, π = 3.14\nr = 5, A = 3.14 × 25 = 78.5 cm².\n\n**Worked example:** Semicircle, r = 6 cm\nA = ½ × 3.14 × 36 = 56.52 cm².",
   "image": null
  },
  {
   "heading": "Volume and capacity",
   "unit": "Measurement",
   "body": "**Volume** = how much space a 3D object takes up (cm³, m³…).\n**Capacity** = how much liquid it holds (mL, L).\n\n**Link:** 1 cm³ = 1 mL, so 1000 cm³ = 1 L.\n\n**Rectangular prism (box):** V = **l × w × h**\n\n**Converting volume:** 1 m³ = 1 000 000 cm³. Capacity: 1 L = 1000 mL.\n\n**Worked example:** Box 5 cm × 4 cm × 3 cm.\nV = 60 cm³ = 60 mL.\n\n**Worked example:** 2.5 L = 2500 mL = 2500 cm³.",
   "image": null
  },
  {
   "heading": "Volume of prisms and cylinders",
   "unit": "Measurement",
   "body": "A **prism** has the same cross-section all the way along. The **base** is that cross-section shape.\n\n**Volume of any prism = area of base × height**\n(Height = the length along the prism, perpendicular to the base.)\n\n**Cylinder** is like a circular prism:\n**V = πr²h**\n\n**Steps**\n1. Identify the base shape\n2. Find the area of the base\n3. Multiply by the height of the prism/cylinder\n\n**Worked example:** Triangular prism, base triangle area 12 cm², length 10 cm.\nV = 12 × 10 = 120 cm³.\n\n**Worked example:** Cylinder r = 3 cm, h = 7 cm, π = 3.14\nV = 3.14 × 9 × 7 = 197.82 cm³.",
   "image": null
  },
  {
   "heading": "Algebra review",
   "unit": "Algebra",
   "body": "**Term** — a number, a letter, or product of both (e.g. 4, x, 3a²).\n**Expression** — terms added/subtracted (e.g. 3x + 2y − 5).\n\n**Substitution:** replace the letter with the number, use BIDMAS.\nIf a = 3, then 2a + 5 = 2(3) + 5 = 11.\n\n**Like terms:** same letters with same powers. 3x and 7x are like; 3x and 3x² are not.\n\n**Add/subtract like terms:** 5x + 3x = 8x. 7ab − 2ab = 5ab.\n\n**Multiply:** multiply numbers, write letters together. 4x × 3y = 12xy.\n\n**Divide:** divide numbers, cancel letters. 12xy ÷ 3x = 4y.\n\n**Expand:** a(b + c) = ab + ac.\nExample: 3(2x − 5) = 6x − 15.\nExample: x(x + 4) = x² + 4x.",
   "image": null
  },
  {
   "heading": "Factorising",
   "unit": "Algebra",
   "body": "Factorising is the **reverse of expanding**.\n\n**How to factorise**\n1. Find the **HCF** of the numbers\n2. Take out any common letters (lowest power)\n3. Write HCF outside brackets, and what is left inside\n4. Check by expanding back\n\n**Examples**\n- 6x + 9 = 3(2x + 3)\n- 10a − 15 = 5(2a − 3)\n- 4x² + 8x = 4x(x + 2)\n- 12xy − 8x = 4x(3y − 2)\n\n**Harder:** 18a²b + 12ab² = 6ab(3a + 2b).",
   "image": null
  },
  {
   "heading": "Applying algebra",
   "unit": "Algebra",
   "body": "Word problems: turn words into an expression or equation.\n\n**Tips**\n- \"More than\" → +\n- \"Less than\" → − (careful with order)\n- \"Times / product\" → ×\n- \"Shared equally\" → ÷\n- \"A number\" → pick a letter (often n or x)\n\n**Example:** \"5 more than double a number\" → 2n + 5.\n\n**Example:** A rectangle is 3 cm longer than it is wide. If width = w, length = w + 3, perimeter = 2(w + w + 3) = 4w + 6.",
   "image": null
  },
  {
   "heading": "Index laws",
   "unit": "Algebra",
   "body": "**Same base** matters for multiply and divide.\n\n**Law 1 — multiply:** aᵐ × aⁿ = aᵐ⁺ⁿ\nExample: x³ × x⁵ = x⁸\n\n**Law 2 — divide:** aᵐ ÷ aⁿ = aᵐ⁻ⁿ\nExample: y⁷ ÷ y² = y⁵\n\n**Zero index:** a⁰ = 1 (as long as a ≠ 0)\nExample: 5⁰ = 1, (2x)⁰ = 1\n\n**Power of a power:** (aᵐ)ⁿ = aᵐⁿ\nExample: (x³)⁴ = x¹²\n\n**Brackets**\n- (ab)ⁿ = aⁿbⁿ\n- (a/b)ⁿ = aⁿ/bⁿ\nExample: (2x)³ = 8x³\nExample: (x²y)³ = x⁶y³\n\n**Common mistakes**\n- Adding bases instead of indices when multiplying\n- Writing a⁰ = 0 instead of 1\n- Forgetting to raise the coefficient to the power: (2x)³ is 8x³, not 2x³",
   "image": null
  },
  {
   "heading": "The number plane",
   "unit": "Graphs",
   "body": "The **number plane** (Cartesian plane) has:\n- **x-axis** — horizontal\n- **y-axis** — vertical\n- **Origin** — (0, 0) where they cross\n\n**Coordinates (x, y)**\n- x = across (positive right, negative left)\n- y = up/down (positive up, negative down)\n\n**Four quadrants**\n- Quadrant I: (+, +)\n- Quadrant II: (−, +)\n- Quadrant III: (−, −)\n- Quadrant IV: (+, −)\n\n**Plotting:** from origin, move x first, then y.\n**Reading:** write the pair in brackets with a comma.",
   "image": null
  },
  {
   "heading": "Rules, tables and graphs",
   "unit": "Graphs",
   "body": "**From rule → table:** pick x values, substitute into the rule, record y.\n\n**From table → graph:** each column is a point (x, y). Plot and join with a straight line if the rule is linear.\n\n**Check a point is on a line:** substitute x and y into the equation. If both sides match, it lies on the line.\n\n**Worked example:** y = 2x − 1, does (3, 5) lie on it?\n2(3) − 1 = 5. Yes, 5 = 5.",
   "image": null
  },
  {
   "heading": "Finding the rule from a table",
   "unit": "Graphs",
   "body": "Linear rules look like **y = mx + c**.\n\n**Steps**\n1. Look at how y changes when x goes up by 1 → that change is **m** (gradient)\n2. Find y when x = 0 → that is **c**. If there is no x = 0 column, substitute any point into y = mx + c and solve for c\n3. Write the rule and check with another point\n\n**Worked example:** x: 0, 1, 2, 3 and y: 1, 4, 7, 10\ny goes up by 3 each time → m = 3. At x = 0, y = 1 → c = 1.\nRule: **y = 3x + 1**.",
   "image": null
  },
  {
   "heading": "x and y intercepts",
   "unit": "Graphs",
   "body": "**y-intercept** — where the line crosses the y-axis. Here **x = 0**. For y = mx + c it is just **c**. Write as **(0, c)**.\n\n**x-intercept** — where the line crosses the x-axis. Here **y = 0**. Substitute y = 0 and solve for x. Write as **(a, 0)**.\n\n**Sketching with intercepts**\n1. Find both intercepts\n2. Plot the two points\n3. Rule a straight line through them\n4. Label the intercepts and the rule\n\n**Worked example:** y = 2x − 6\ny-intercept: (0, −6)\nx-intercept: 0 = 2x − 6 → x = 3 → (3, 0)",
   "image": null
  },
  {
   "heading": "Gradient",
   "unit": "Graphs",
   "body": "**Gradient (m)** = steepness = **rise ÷ run**.\n\n- **Positive** — line goes up left → right\n- **Negative** — line goes down left → right\n- **Zero** — horizontal line (e.g. y = 4)\n- **Undefined** — vertical line (e.g. x = 3); run = 0 so you can't divide\n\n**Between two points (x₁, y₁) and (x₂, y₂):**\nm = (y₂ − y₁) ÷ (x₂ − x₁)\n\n**Worked example:** (1, 2) and (4, 8)\nm = (8 − 2) ÷ (4 − 1) = 6 ÷ 3 = 2.",
   "image": null
  },
  {
   "heading": "Gradient-intercept form",
   "unit": "Graphs",
   "body": "**y = mx + c**\n- **m** = gradient\n- **c** = y-intercept\n\n**From a graph:** read c where it crosses the y-axis; count rise/run for m.\n\n**Horizontal lines:** y = k (gradient 0).\n**Vertical lines:** x = k (undefined gradient — not written as y = mx + c).\n\n**Worked example:** gradient 2, passes through (0, −3).\nRule: **y = 2x − 3**.",
   "image": null
  },
  {
   "heading": "Applications of straight-line graphs",
   "unit": "Graphs",
   "body": "Linear graphs model **constant rates of change**.\n\nExamples:\n- Distance vs time at steady speed\n- Cost vs number of items (fixed price each, maybe plus a hire fee)\n- Water filling a tank at a steady rate\n\n**Reading the graph**\n- Gradient = rate (e.g. km per hour, $ per item)\n- y-intercept = starting value (e.g. initial fee, starting distance)\n\n**Example:** A bike hire costs $12 plus $5 per hour.\nC = 5t + 12\nAfter 3 hours: C = 5(3) + 12 = $27.",
   "image": null
  },
  {
   "heading": "Formula sheet",
   "unit": "Measurement",
   "body": "**Length / perimeter**\n- C = 2πr = πd\n- Semicircle perimeter ≈ πr + 2r\n\n**Area**\n- Square s² · Rectangle lw · Triangle ½bh · Parallelogram bh\n- Kite/rhombus ½d₁d₂ · Trapezium ½(a+b)h\n- Circle πr² · Semicircle ½πr² · Quadrant ¼πr²\n\n**Volume**\n- Rectangular prism lwh\n- Any prism: base area × height\n- Cylinder πr²h\n- 1 cm³ = 1 mL · 1000 cm³ = 1 L · 1 ha = 10 000 m²\n\n**Algebra / indices**\naᵐ × aⁿ = aᵐ⁺ⁿ · aᵐ ÷ aⁿ = aᵐ⁻ⁿ · a⁰ = 1 · (aᵐ)ⁿ = aᵐⁿ · (ab)ⁿ = aⁿbⁿ\n\n**Graphs**\ny = mx + c · m = rise/run · x-intercept: y = 0 · y-intercept: x = 0",
   "image": null
  },
  {
   "heading": "Common mistakes",
   "unit": "Measurement",
   "body": "**Measurement**\n- Forgetting to convert units before calculating\n- Using diameter in πr² without halving\n- Missing outer edges on composite perimeters\n- Using slanted side as height instead of perpendicular height\n\n**Algebra**\n- Adding unlike terms (3x + 2y ≠ 5xy)\n- Writing a⁰ = 0\n- (2x)³ → writing 2x³ instead of 8x³\n- Expanding only the first term in brackets\n\n**Graphs**\n- Writing coordinates as (y, x)\n- Gradient as run/rise instead of rise/run\n- Mixing up x- and y-intercept methods\n- Joining points that should be a straight line with a curve because of an arithmetic error",
   "image": null
  }
 ],
 "terms": [
  ...
  },
  {
   "term": "Diameter",
   "unit": "Measurement",
   "definition": "Distance across a circle through the centre. d = 2r."
  },
  {
   "term": "Area",
   "unit": "Measurement",
   "definition": "The amount of surface a 2D shape covers, measured in square units."
  },
  {
   "term": "Trapezium",
   "unit": "Measurement",
  ...
  },
  {
   "term": "Rhombus",
   "unit": "Measurement",
   "definition": "A quadrilateral with all sides equal. Area = ½ × d₁ × d₂."
  },
  {
   "term": "Volume",
   "unit": "Measurement",
   "definition": "The amount of space a 3D object occupies, in cubic units."
  },
  {
   "term": "Capacity",
   "unit": "Measurement",
   "definition": "How much liquid a container can hold (mL or L)."
  },
  {
   "term": "Prism",
   "unit": "Measurement",
   "definition": "A 3D shape with the same cross-section all the way along."
  },
  {
   "term": "Like terms",
   "unit": "Algebra",
   "definition": "Terms with the same letter parts and powers, e.g. 3x and 7x."
  },
  {
   "term": "Expand",
   "unit": "Algebra",
   "definition": "Remove brackets by multiplying: a(b + c) = ab + ac."
  },
  {
   "term": "Factorise",
   "unit": "Algebra",
   "definition": "Take out a common factor and rewrite with brackets."
  },
  {
   "term": "Index / power",
   "unit": "Algebra",
   "definition": "The small number that says how many times to multiply the base, e.g. the 3 in x³."
  },
  {
   "term": "Origin",
   "unit": "Graphs",
   "definition": "The point (0, 0) where the x-axis and y-axis cross."
  },
  {
   "term": "Gradient",
   "unit": "Graphs",
   "definition": "Steepness of a line: rise ÷ run. Written as m in y = mx + c."
  },
  {
   "term": "y-intercept",
   "unit": "Graphs",
   "definition": "Where the line crosses the y-axis. The value of c when x = 0."
  },
  {
   "term": "x-intercept",
   "unit": "Graphs",
   "definition": "Where the line crosses the x-axis. Found by setting y = 0."
  }
 ],
 "cards": [
  {
   "front": "How do you convert 3.2 m to cm?",
   "back": "Multiply by 100 → 320 cm. Going to a smaller unit means more of them."
  },
  {
   "front": "Write the two circumference formulas.",
   "back": "C = 2πr and C = πd."
  },
  {
   "front": "Area of a triangle?",
   "back": "A = ½ × base × perpendicular height."
  },
  {
   "front": "Area of a trapezium?",
   "back": "A = ½(a + b)h, where a and b are the parallel sides."
  },
  {
   "front": "Area of a circle?",
   "back": "A = πr². Halve the diameter first if that is what you are given."
  },
  {
   "front": "Volume of a prism?",
   "back": "Area of the base × height (length along the prism)."
  },
  {
  ...
  {
   "front": "What are like terms?",
   "back": "Terms with identical letter parts and powers, e.g. 4x and −9x."
  },
  {
   "front": "Expand 5(2x − 3).",
   "back": "10x − 15."
  ...
  {
   "front": "Factorise 6x + 15.",
   "back": "3(2x + 5)."
  },
  {
   "front": "Simplify x⁴ × x³.",
   "back": "x⁷ (add the indices)."
  },
  {
   "front": "Simplify (x²)⁵.",
   "back": "x¹⁰ (multiply the indices)."
  },
  {
   "front": "What is a⁰ equal to?",
   "back": "1 (if a is not zero)."
  },
  {
   "front": "What does m mean in y = mx + c?",
   "back": "The gradient (steepness and direction of the line)."
  },
  {
   "front": "What does c mean in y = mx + c?",
   "back": "The y-intercept — where the line crosses the y-axis."
  },
  {
   "front": "How do you find the x-intercept from a rule?",
   "back": "Set y = 0 and solve for x. Write the answer as (x, 0)."
  },
  {
   "front": "Gradient between (2, 3) and (6, 11)?",
   "back": "(11 − 3) ÷ (6 − 2) = 8 ÷ 4 = 2."
  },
  {
   "front": "Gradient of a horizontal line?",
  ...
  {
   "front": "Gradient of a vertical line?",
   "back": "Undefined. Example: x = 4."
  },
  {
   "front": "Name the four quadrants' sign patterns.",
   "back": "I (+,+), II (−,+), III (−,−), IV (+,−)."
  }
 ],
 "quick": [
  {
   ...
   "answer": 1,
   "why": "× 100 to go from m to cm."
  },
  {
   "q": "Perimeter of a 7 cm by 4 cm rectangle?",
   "options": [
    "11 cm",
    "28 cm",
    "22 cm",
  ...
  {
   "q": "If r = 6, which formula is ready to use for circumference?",
   "options": [
    "C = πd",
    "C = 2πr",
    "A = πr²",
   ...
   "answer": 1,
   "why": "You have radius, so C = 2πr."
  },
  {
   "q": "Diameter is 10 cm. Circumference (π = 3.14)?",
   "options": [
    "31.4 cm",
    "15.7 cm",
    "62.8 cm",
   ...
   "answer": 0,
   "why": "C = πd = 3.14 × 10 = 31.4."
  },
  {
   "q": "Area of a triangle, base 10, height 6?",
   "options": [
    "60",
    "30",
    "16",
  ...
  {
   "q": "d = 8 cm. Area of circle (π = 3.14)?",
   "options": [
    "50.24",
    "25.12",
    "200.96",
   ...
   "answer": 0,
   "why": "r = 4, A = 3.14 × 16 = 50.24."
  },
  {
   "q": "Rhombus diagonals 12 and 5. Area?",
   "options": [
    "60",
    "30",
    "17",
  ...
  {
   "q": "Trapezium parallel sides 5 and 9, height 4. Area?",
   "options": [
    "28",
    "36",
    "20",
  ...
  },
  {
   ...
   "answer": 0,
   "why": "Like terms: 4 + 7 = 11, keep the x."
  },
  {
   "q": "Expand 3(x + 4).",
   "options": [
  ...
  },
  {
   ...
   "answer": 2,
   "why": "Anything non-zero to the power 0 is 1."
  },
  {
   "q": "Point (−3, 5) is in quadrant…",
   "options": [
    "I",
    "II",
    "III",
   ...
   "answer": 1,
   "why": "x negative, y positive → II."
  },
  {
   "q": "In y = 4x − 1, the gradient is…",
   "options": [
    "−1",
    "4",
    "4x",
  ...
  },
  {
   ...
   "answer": 1,
   "why": "When x = 0, y = 7 → (0, 7)."
  },
  {
   "q": "x-intercept of y = 2x − 8?",
   "options": [
    "(0, −8)",
    "(4, 0)",
    "(8, 0)",
  ...
  {
   "q": "Semicircle area with r = 4, π = 3.14?",
   "options": [
    "50.24",
    "25.12",
    "12.56",
 ...
 "practice": [
  ...
  {
   "topic": "Length & Perimeter",
   "q": "A rectangle is 12 cm by 5 cm. Find its perimeter.",
   "answer": "34 cm",
   "accept": [
    "34",
    "34cm"
  ...
  {
   "topic": "Circumference",
   "q": "Find the circumference of a circle with radius 7 cm. Use π = 3.14.",
   "answer": "43.96 cm",
   "accept": [
    "43.96",
    "43.96cm"
   ],
   "why": "C = 2 × 3.14 × 7 = 43.96."
  },
  {
   "topic": "Circumference",
   "q": "Find the circumference when the diameter is 9 cm. Use π = 3.14.",
   "answer": "28.26 cm",
   "accept": [
    "28.26",
    "28.26cm"
  ...
  {
   "topic": "Circumference",
   "q": "A semicircle has radius 5 cm. Find the perimeter (curved part + diameter). Use π = 3.14.",
   "answer": "25.7 cm",
   "accept": [
    "25.7",
    "25.70",
   ...
   "why": "πr + 2r = 3.14×5 + 10 = 15.7 + 10 = 25.7."
  },
  {
   "topic": "Area",
   "q": "Find the area of a triangle with base 14 cm and height 6 cm.",
   "answer": "42 cm²",
   "accept": [
    "42",
    "42cm2",
  ...
  {
   "topic": "Area",
   "q": "A parallelogram has base 11 m and perpendicular height 4 m. Find the area.",
   "answer": "44 m²",
   "accept": [
    "44",
    "44m2",
  ...
  },
  {
   ...
   "q": "A kite has diagonals 16 cm and 9 cm. Find its area.",
   "answer": "72 cm²",
   "accept": [
    "72",
    "72cm2"
  ...
  {
   "topic": "Special Quadrilaterals",
   "q": "A trapezium has parallel sides 8 cm and 12 cm and height 5 cm. Find the area.",
   "answer": "50 cm²",
   "accept": [
    "50",
    "50cm2"
  ...
  },
  {
   ...
   "q": "Find the area of a circle with radius 6 cm. Use π = 3.14.",
   "answer": "113.04 cm²",
   "accept": [
    "113.04",
    "113.04cm2"
  ...
  {
   "topic": "Area of Circles",
   "q": "A circle has diameter 14 cm. Find the area using π = 3.14.",
   "answer": "153.86 cm²",
   "accept": [
    "153.86",
    "153.86cm2"
   ],
   "why": "r = 7, A = 3.14 × 49 = 153.86."
  },
  {
   "topic": "Volume",
   "q": "A rectangular prism measures 8 cm × 3 cm × 5 cm. Find the volume.",
   "answer": "120 cm³",
   "accept": [
    "120",
    "120cm3"
  ...
  {
   "topic": "Volume",
   "q": "A cylinder has radius 4 cm and height 10 cm. Find the volume using π = 3.14.",
   "answer": "502.4 cm³",
   "accept": [
    "502.4",
    "502.4cm3"
   ],
   "why": "3.14 × 16 × 10 = 502.4."
  },
  {
   "topic": "Algebra",
   "q": "If x = 5, evaluate 3x − 7.",
   "answer": "8",
   "accept": [
    "8"
   ],
  ...
  {
   "topic": "Graphs",
   "q": "Using y = 3x − 2, what is y when x = 4?",
   "answer": "10",
   "accept": [
    "10"
   ],
  ...
  {
   "topic": "Graphs",
   "q": "Write the y-intercept of y = −5x + 3 as a coordinate.",
   "answer": "(0, 3)",
   "accept": [
    "(0,3)",
    "0,3"
  ...
  {
   "topic": "Graphs",
   "q": "Find the gradient between (1, 5) and (3, 11).",
   "answer": "3",
   "accept": [
    "3",
    "+3"
  ...
  {
   "topic": "Graphs",
   "q": "A table has x = 0,1,2,3 and y = 2,5,8,11. Write the rule.",
   "answer": "y = 3x + 2",
   "accept": [
    "y=3x+2",
    "3x+2"
  ...
  {
   "topic": "Graphs",
   "q": "Bike hire is $8 plus $6 per hour. Write a rule for cost C after t hours.",
   "answer": "C = 6t + 8",
   "accept": [
    "C=6t+8",
    "C = 6t+8"
   ],
   "why": "Rate 6, starting fee 8."
  }
 ],
 "quiz": [
  {
   "q": "A rectangular garden is 12 m long and 7 m wide. A path 1 m wide runs all the way around the outside. Find the perimeter of the outer edge of the path.",
   "a": "Outer length = 12 + 2 = 14 m, outer width = 7 + 2 = 9 m. Perimeter = 2(14 + 9) = 46 m.",
   "hint": "The path adds 1 m on every side."
  },
  {
   "q": "A circle has diameter 16 cm. Find the circumference and the area using π = 3.14.",
   "a": "r = 8. C = 3.14 × 16 = 50.24 cm. A = 3.14 × 64 = 200.96 cm².",
   "hint": "Halve the diameter before using πr²."
  },
  {
   "q": "A running track has two straight sections of 80 m and two semicircle ends that together make one full circle of radius 20 m. Find the total length of one lap using π = 3.14.",
   "a": "Straights: 2 × 80 = 160 m. Circle ends: C = 2 × 3.14 × 20 = 125.6 m. Lap = 160 + 125.6 = 285.6 m.",
   "hint": "Two semicircles = one full circumference."
  },
  {
   "q": "A trapezium has parallel sides 9 cm and 15 cm. Its area is 72 cm². Find the perpendicular height.",
   "a": "72 = ½(9 + 15)h → 72 = 12h → h = 6 cm.",
   "hint": "Substitute into ½(a+b)h and solve for h."
  },
  {
   "q": "A triangular prism has a triangular base with area 24 cm² and a length of 15 cm. Find the volume.",
   "a": "V = base area × length = 24 × 15 = 360 cm³.",
   "hint": "Prism volume is always base area times the length."
  },
  {
   "q": "Expand and simplify 2(3x − 4) − 3(x + 1).",
   "a": "6x − 8 − 3x − 3 = 3x − 11.",
   "hint": "Expand each bracket first, then combine like terms."
  },
  {
   "q": "Factorise fully: 12x²y − 18xy.",
   "a": "6xy(2x − 3).",
   "hint": "HCF of numbers is 6; both terms have x and y."
  },
  {
   "q": "Simplify (2a³)⁴ ÷ a².",
   "a": "(2a³)⁴ = 16a¹². Then 16a¹² ÷ a² = 16a¹⁰.",
   "hint": "Raise the coefficient and multiply indices, then subtract for division."
  },
  {
   "q": "A table shows x = −1, 0, 1, 2 and y = 5, 3, 1, −1. Find the rule y = mx + c.",
   "a": "y falls by 2 when x rises by 1, so m = −2. When x = 0, y = 3, so c = 3. Rule: y = −2x + 3.",
   "hint": "Read the change in y, then look under x = 0."
  },
  {
   "q": "Find both intercepts of y = −3x + 9 and describe how you would sketch the line.",
   "a": "y-intercept (0, 9). x-intercept: 0 = −3x + 9 → x = 3 → (3, 0). Plot both points, rule a straight line, label intercepts and the equation.",
   "hint": "Two points define a straight line."
  },
  {
   "q": "A taxi charges a flag fall of $5 plus $2.20 per kilometre. Write a rule for cost C in terms of distance d km, and find the cost of an 8 km trip.",
   "a": "C = 2.2d + 5. For 8 km: C = 2.2(8) + 5 = 17.6 + 5 = $22.60.",
   "hint": "Gradient is the rate; intercept is the fixed fee."
  },
  {
   "q": "Explain why the gradient of a vertical line is undefined.",
   "a": "Gradient = rise ÷ run. On a vertical line the run is 0, and division by zero is not possible, so the gradient is undefined.",
